            ...
            <div className="min-h-screen">
                ...
                <div className="flex flex-col w-3/5 justify-center ml-80 mt-10">
                    ...
                    <p className="text-gray-600 mt-4">
                        <p className="underline">Réduction de la consommation d'énergie :</p>
                    ...
                    <p className="text-gray-600 mt-4">
                        <p className="underline">Design minimaliste :</p>
                    ...
                    <p className="text-gray-600 mt-4">
                        <p className="underline">Réduction du temps de navigation :</p>
                ...
                <div className="flex flex-col w-3/5 justify-center ml-80 mt-10 mb-10">
                    ...
                    <p className="text-gray-600 mt-4">
                        <p className="underline">Performance optimale grâce au rendu hybride (SSR et SSG) :</p>
                    ...
                    <p className="text-gray-600 mt-4">
                        <p className="underline">Expérience utilisateur améliorée avec le chargement rapide :</p>
                    ...
                    <p className="text-gray-600 mt-4">
                        <p className="underline">Écosystème complet et facile à utiliser :</p>
